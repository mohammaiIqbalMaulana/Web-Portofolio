...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-8 sm:py-12 md:py-16 bg-gradient-to-br from-rose-50 via-pink-50/20 to-red-50/30 dark:from-secondary-900 dark:via-rose-900/5 dark:to-red-900/10 relative overflow-hidden" style={{ transition: 'none' }}>
      ...
      <div className="absolute top-16 right-16 w-80 h-80 bg-rose-400/15 rounded-full blur-3xl"></div>
      <div className="absolute bottom-24 left-20 w-64 h-64 bg-pink-400/15 rounded-full blur-3xl"></div>
      <div className="absolute top-1/4 left-1/6 w-96 h-96 bg-red-500/8 rounded-full blur-3xl"></div>
      <div className="absolute top-1/3 right-1/4 w-72 h-72 bg-rose-300/10 rounded-full blur-3xl"></div>
      <div className="absolute top-2/3 left-1/3 w-56 h-56 bg-pink-300/12 rounded-full blur-3xl"></div>
